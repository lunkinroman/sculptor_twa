        ...
        const TASKS = [
          {
            ...
            desc: '<p>Выполни все 18 тренировок, нажимая “Выполнено” под каждой тренировкой</p>'
          },
          {
            title: 'Фото/видео в красивом наряде',
            desc: '<p>Сделай фото или видео, чтобы увидеть свою трансформацию и поделиться этим. ✨</p><ul><li>Выдели время, чтобы подготовиться.</li><li>Сделай макияж, с которым ты чувствуешь себя красивой.</li><li>Удели внимание волосам. Сделай красивые локоны или причёску.</li><li>Надень наряд, в котором чувствуешь себя привлекательно: обтягивающее женственное платье, юбку или красивый костюм.</li></ul>'
          },
          {
            title: 'Отзыв',
            desc: '<p>Поделись своими честными ощущениями и результатами.</p><p>Ответь в видео на вопросы:</p><ul><li>Что тебе больше всего понравилось в марафоне?</li><li>Какие результаты ты получила? (желанный размер одежды, изменения в питании, объёмы тела, физическое и эмоциональное состояние, отношения с близкими)</li><li>Будешь ли ты рекомендовать другим пройти этот марафон? Почему?</li></ul><p>Обрати внимание, чтобы картинка видео была чёткой, а звук качественным, тебя было хорошо видно и слышно! 🤍</p>'
          },
          {
            title: 'Влог — мой день',
            desc: '<p>Сними атмосферное видео о своей жизни: фрагменты из дня, который проживаешь.</p><ul><li>Покажи утро, приёмы пищи — питание по методу здоровой тарелки, то, как выполняешь тренировки, чем занимаешься в течение дня.</li><li>Обрати внимание, чтобы картинка была чёткой и атмосферной, а звук качественным.</li><li>Обязательно запиши озвучку. Не забудь проговорить, какие изменения ты заметила после прохождения марафона: желанная форма, новые привычки, ощущения.</li></ul>'
          },
          {
            title: 'Фото до/после',
            desc: '<p>Отправь свои фото До и После в этот бот</p>'
          }
        ];
